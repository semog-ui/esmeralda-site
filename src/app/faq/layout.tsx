...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "FAQ",
    description:
      "Respostas para dúvidas comuns sobre desenvolvimento web, projetos e tecnologias da Esmeralda.",
    url: `${SITE_URL}/faq`,
    images: [
      {
  ...
  twitter: {
    ...
    title: "FAQ ",
    description:
      "Respostas para dúvidas comuns sobre desenvolvimento web e projetos.",
